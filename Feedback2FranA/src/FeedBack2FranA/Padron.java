 ...
 * @author Fran
 */
public class Padron extends Poblacion{
    ...
    //Constructor
    public Padron(String comunAutonoma, String provincia, String nomPoblacion, Integer anioPadron, Integer numHabitantes, Double porcenAnioAnt){
